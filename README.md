...
Для вайбкодерів: Cursor / Claude / Codex і подібне. Якщо хочеш відкрити чужого кота, перекодити і щоб сказали «вах, який молодець».

Коти — обгортка, щоб не було сухо. Це не гра «погладь котика».

Хто пише руками — теж грає. Арена просто заточена під вайб з першого дня, а не під «спочатку вивчи JS».
